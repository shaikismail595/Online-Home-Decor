...
<body>
    ...
    <div class="container mt-5">
                ...
                <tbody>
                    <c:forEach items="${orders}" var="order">
                        <tr>
                            ...
                            <td>${order.status}</td>
                            <td>
                                <form action="${pageContext.request.contextPath}/order/updateOrderStatus" method="post" class="d-flex justify-content-center align-items-center">
        ...
        <div class="back-to-dashboard">
            ...
            <a href="${url_vhome}" class="btn btn-warning">
