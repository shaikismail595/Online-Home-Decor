...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="${pageContext.request.contextPath}/vendor/dashboard" class="btn btn-secondary back-button">Back to Vendor Dashboard</a>
        <a href="${pageContext.request.contextPath}/product/add" class="btn btn-primary mb-3">Add New Product</a>
