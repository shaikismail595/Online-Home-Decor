...
import com.yash.ohd.command.LoginCommand;
import com.yash.ohd.command.UserCommand;
...
public class UserController {
    ...
    public String handleLogin(@ModelAttribute("command") LoginCommand cmd, Model m, HttpSession session) {
        try {
            ...
            //check the role and redirect to a appropriate dashboard
            {
                ...
                } else if (loggedInUser.getRole().equals(UserService.ROLE_VENDOR)) {
                    //add user detail in session (assign session to logged in user)
                    addUserInSession(loggedInUser, session);
    ...
    @RequestMapping(value = "/vendor/dashboard")
    public String vendorDashboard() {
        return "dashboard_vendor"; //JSP
    }
    ...
    public String getVendorList(Model m) {
        m.addAttribute("vendorList", userService.getVendorList());
        return "vendors"; //JSP
    }
