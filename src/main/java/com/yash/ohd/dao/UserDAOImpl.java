...
public class UserDAOImpl extends BaseDAO implements UserDAO {
    ...
    public void save(User u) {
        String sql = "INSERT INTO user(name, phone, email, address, loginName, password, role, loginStatus)"
                + " VALUES(:name, :phone, :email, :address, :loginName, :password, :role, :loginStatus)"; //named parameter declared using colon
        Map m = new HashMap();
        ...
        SqlParameterSource ps = new MapSqlParameterSource(m); //from where the parameter is taken from database
